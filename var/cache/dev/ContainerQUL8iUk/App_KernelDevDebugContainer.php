...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Serializer/AdminGroupsContextBuilder.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('TlTR0yfdGu', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XC4zy+L8tz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityListenerResolverService()
    {
        $this->services['doctrine.orm.default_entity_listener_resolver'] = $instance = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerEntityListenerResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Doctrine\\CheeseListingSetOwnerListener' => ['privates', 'App\\Doctrine\\CheeseListingSetOwnerListener', 'getCheeseListingSetOwnerListenerService', true],
        ], [
            'App\\Doctrine\\CheeseListingSetOwnerListener' => '?',
        ]));

        $instance->registerService('App\\Doctrine\\CheeseListingSetOwnerListener', 'App\\Doctrine\\CheeseListingSetOwnerListener');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\CheeseNotificationRepository' => ['privates', 'App\\Repository\\CheeseNotificationRepository', 'getCheeseNotificationRepositoryService', true],
            ...
            'App\\Repository\\CheeseNotificationRepository' => '?',
    ...
    protected function getSerializerService()
    {
        ...
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => new \App\Serializer\Normalizer\UserNormalizer(($this->privates['security.helper'] ?? $this->getSecurity_HelperService())), 2 => $h, 3 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($e, [], $i), 4 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $i), 5 => $h, 6 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($b, $c, $d, $j, NULL, $e, $f, $i), 7 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($b, $k, $e), 8 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($e, true), 9 => new \ApiPlatform\Core\Hal\Serializer\EntrypointNormalizer($b, $k, $e), 10 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 11 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 12 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($b, $c, $d, $k, $j, $l, $a, $i, $m, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), false), 13 => new \ApiPlatform\Core\Hal\Serializer\ItemNormalizer($c, $d, $k, $j, $a, $i, $m, NULL, false, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $b, false), 14 => new \ApiPlatform\Core\Serializer\ItemNormalizer($c, $d, $k, $j, $a, $i, $m, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $b, false), 15 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 16 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 17 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $i), 18 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 21 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($l, $j, $k), 'page', 'pagination', $b, $a), $b, $j, $g), 22 => new \ApiPlatform\Core\Hal\Serializer\CollectionNormalizer($j, 'page'), 23 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 24 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($n, $k, $l), 25 => new \ApiPlatform\Core\Hal\Serializer\ObjectNormalizer($n, $k), 26 => $n], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonhal'), 6 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('meBzD8Xw3W', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xlv9da9Uy5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uJRcM+r6N+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'annotated_app_entity_user_api_platform_core_serializer_filter_property_filter' => ['privates', 'annotated_app_entity_user_api_platform_core_serializer_filter_property_filter', 'getAnnotatedAppEntityUserApiPlatformCoreSerializerFilterPropertyFilterService', true],
        ], [
            ...
            'annotated_app_entity_user_api_platform_core_serializer_filter_property_filter' => '?',
        ]);
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VGknfj5tHc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0iniR88LiH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FGral9K+0S', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jQXtjbvucW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3ygkq6Aw2O', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7EFJ1ZOgIn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['debug.security.voter.App\\Security\\Voter\\CheeseListingVoter'] ?? $this->load('getCheeseListingVoterService'));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Validator\\IsValidOwnerValidator' => ['privates', 'App\\Validator\\IsValidOwnerValidator', 'getIsValidOwnerValidatorService', true],
            ...
            'App\\Validator\\IsValidOwnerValidator' => '?',
