...
return [
    ...
    [ // $staticRoutes
        ...
        '/' => [[['_route' => 'app_frontend_homepage', '_controller' => 'App\\Controller\\FrontendController::homepage'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        347 => [
            ...
            [['_route' => 'api_cheeses_delete_item', '_controller' => 'api_platform.action.delete_item', '_format' => null, '_api_resource_class' => 'App\\Entity\\CheeseListing', '_api_item_operation_name' => 'delete'], ['id', '_format'], ['DELETE' => 0], null, false, true, null],
        ],
        384 => [
