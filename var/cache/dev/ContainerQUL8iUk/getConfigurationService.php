...
class getConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setModelFactoryManager(new \Zenstruck\Foundry\ModelFactoryManager(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Factory\\CheeseListingFactory'] ?? ($container->privates['App\\Factory\\CheeseListingFactory'] = new \App\Factory\CheeseListingFactory()));
            yield 1 => ($container->privates['App\\Factory\\CheeseNotificationFactory'] ?? ($container->privates['App\\Factory\\CheeseNotificationFactory'] = new \App\Factory\CheeseNotificationFactory()));
            yield 2 => ($container->privates['App\\Factory\\UserFactory'] ?? ($container->privates['App\\Factory\\UserFactory'] = new \App\Factory\UserFactory()));
        }, 3)));
