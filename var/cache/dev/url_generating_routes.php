...
return [
    ...
    'app_frontend_homepage' => [[], ['_controller' => 'App\\Controller\\FrontendController::homepage'], [], [['text', '/']], [], []],
    ...
    'api_cheeses_delete_item' => [['id', '_format'], ['_controller' => 'api_platform.action.delete_item', '_format' => null, '_api_resource_class' => 'App\\Entity\\CheeseListing', '_api_item_operation_name' => 'delete'], [], [['variable', '.', '[^/]++', '_format', true], ['variable', '/', '[^/\\.]++', 'id', true], ['text', '/api/cheeses']], [], []],
];
